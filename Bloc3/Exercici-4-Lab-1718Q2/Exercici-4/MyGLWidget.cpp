...
void MyGLWidget::modelTransformModel ()
{
  ...
  TG = glm::translate(TG, glm::vec3(-0.5f,0.f,-0.5f));
  TG = glm::rotate(TG,float(M_PI/4), glm::vec3(0.f,1.f,0.f));
...
void MyGLWidget::modelTransformModel2 ()
{
  glm::mat4 TG(1.f);  // Matriu de transformació
    TG = glm::translate(TG, glm::vec3(0.5f,0.f,0.5f));
  TG = glm::rotate(TG,float(M_PI+M_PI/4), glm::vec3(0.f,1.f,0.f));
...
void MyGLWidget::viewTransform ()
{
 glm::mat4 View = glm::mat4(1.0f);
	View=glm::translate(View,glm::vec3(0.f,0.f,-2*radiEsc));
	View = glm::rotate(View,RotaY, glm::vec3(1,0,0));
	View = glm::rotate(View,RotaX, glm::vec3(0,1,0));

	glm::vec3 centre_escena = glm::vec3(0,1,0); //Hardcodejat
...
void MyGLWidget::posLlum() {
    glm::vec3 PF = glm::vec3(posFocus);
    // PF = Pos Focus
    glUniform3fv(posFocusLoc, 1, &PF[0]);
}

void MyGLWidget::colLlum() {
    glm::vec3 CF = glm::vec3(colFocus);
    // CF = Col Focus
